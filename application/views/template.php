...
<link href="<?php echo base_url(); ?>css/basic.css" type="text/css"
	rel="stylesheet" media="all" />
<link href="<?php echo base_url(); ?>css/color.css" type="text/css"
	rel="stylesheet" media="screen" />
<link href="<?php echo base_url(); ?>css/ui.theme.css" type="text/css"
	rel="stylesheet" media="screen" />
...
<script type="text/javascript"
	src="<?php echo base_url();?>js/jquery.dirtyforms.js"></script>
...
<script type="text/javascript"
	src="<?php echo base_url();?>js/vendor.js"></script>
</head>
<body>
	<div id="page">
